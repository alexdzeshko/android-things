...
public class Camera2BasicFragment extends Fragment
    ...
    private ImageView mLastCapturedImageView;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mLastCapturedImageView = view.findViewById(R.id.lastCapturedImage);
        mLastCapturedImageView.setOnClickListener(this);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onActivityCreated: "+mFile.getAbsolutePath());
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lastCapturedImage: {
                FaceRecognitionActivity.start(getContext(), mFile);
            }
        }
    }
